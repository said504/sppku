...
<head>
    ...
    <title>{{ config('app.name', 'SPP System') }}</title>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav-list">
            @if(auth()->user()->role === 'admin')
                <li class="nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="nav-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem;">
                        <svg style="width: 20px; height: 20px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                        Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('admin.students') }}" class="nav-link {{ request()->routeIs('admin.students') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem;">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.tunggakan') }}" class="nav-link {{ request()->routeIs('admin.tunggakan') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem;">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.rules') }}" class="nav-link {{ request()->routeIs('admin.rules') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem;">
            ...
            @else
                <li class="nav-item">
                    <a href="{{ route('parent.dashboard') }}" class="nav-link {{ request()->routeIs('parent.dashboard') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem;">
                ...
                <li class="nav-item">
                    <a href="{{ route('parent.invoices') }}" class="nav-link {{ request()->routeIs('parent.invoices') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem;">
                ...
                <li class="nav-item">
                    <a href="{{ route('parent.history') }}" class="nav-link {{ request()->routeIs('parent.history') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem;">
