...
<div class="stats-grid">
    <div class="glass-card stat-card" style="border-color: var(--success);">
        ...
        <div class="stat-value" style="color: var(--success);">Rp <?php echo e(number_format($stats['pemasukan'], 0, ',', '.')); ?></div>
    </div>
    <div class="glass-card stat-card" style="border-color: var(--orange);">
        <div style="color: #666;">Total Tunggakan</div>
        <div class="stat-value" style="color: var(--orange);">Rp <?php echo e(number_format($stats['tunggakan'], 0, ',', '.')); ?></div>
    </div>
    <div class="glass-card stat-card" style="border-color: var(--accent-blue);">
        <div style="color: #666;">Siswa Aktif</div>
        <div class="stat-value" style="color: var(--accent-blue);"><?php echo e($stats['siswa_aktif']); ?> Siswa</div>
    </div>
</div>
    ...
    <div class="glass-card" style="flex: 1; min-width: 300px;">
        ...
        <div id="activityFeed">
            ...
            <div style="padding: 1rem; border-left: 4px solid var(--success); background: white; margin-bottom: 0.75rem; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.02);">
                <div style="font-weight: 700;"><?php echo e($act->student_name); ?></div>
                <div style="font-size: 0.9rem; color: #666;">Membayar Rp <?php echo e(number_format($act->amount, 0, ',', '.')); ?> (<?php echo e($act->description); ?>)</div>
                <div style="font-size: 0.8rem; color: #999; margin-top: 0.25rem;"><?php echo e($act->created_at->diffForHumans()); ?></div>
            </div>
...
new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Pemasukan',
            data: [12000000, 15000000, 15000000, 15000000, 13500000, <?php echo e($stats['pemasukan']); ?>],
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mytz data enginer\SPP_SYSTEM\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>