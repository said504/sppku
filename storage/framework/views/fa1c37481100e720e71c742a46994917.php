    ...
    <div style="display: grid; gap: 1rem;">
        ...
        <div style="background: rgba(30,58,95,0.03); border: 1px solid var(--border-color); border-radius: 12px; padding: 1.5rem;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1rem;">
                <div>
                    <h4 style="margin: 0 0 0.5rem 0;"><?php echo e($rule->name); ?></h4>
                    <span class="badge <?php echo e($rule->is_active ? 'badge-lunas' : 'badge-tunggakan'); ?>"><?php echo e($rule->is_active ? 'Aktif' : 'Non-Aktif'); ?></span>
                </div>
                <div style="font-size: 1.25rem; font-weight: 800; color: var(--accent-blue);">
                    -<?php echo e((float)$rule->discount_percentage); ?>%
                </div>
            </div>
            
            <div style="background: #1e1e1e; color: #d4d4d4; padding: 1rem; border-radius: 8px; font-family: monospace; font-size: 0.9rem;">
                <span style="color: #569cd6;">IF</span>( <span style="color: #9cdcfe;"><?php echo e($rule->condition); ?></span> ) <br>
                <span style="color: #569cd6;">THEN</span> ( <span style="color: #9cdcfe;">Tagihan</span> * <span style="color: #ce9178;"><?php echo e((100 - $rule->discount_percentage) / 100); ?></span> )
            </div>
            
            <div style="margin-top: 1rem; text-align: right; display: flex; justify-content: flex-end; gap: 0.5rem;">
                <form action="<?php echo e(route('admin.rules.delete', $rule->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus rule ini?');">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mytz data enginer\SPP_SYSTEM\resources\views/admin/rules.blade.php ENDPATH**/ ?>